        ...
        <>
            <div className={`${theme === 'light' ? "bg-white" : ""} sx:max-sm:text-[10px] `} id='Over'>
                ...
                <div className='flex flex-col items-center justify-center  sx:max-sm:text-sm '>
                    <div className={`overview ${theme === 'light' ? "bg-white" : "bg-[#1e293b] "} mt-10  px-4 py-4 rounded-lg w-[60%]  sx:max-sm:text-sm sx:max-sm:w-[100%]  `}>
                    ...
                    <div className={`overview bg-[#1e293b] mt-10 ${theme === 'light' ? "bg-white text-[#131834]" : "bg-[#1e293b] text-[#a5b4fc] "}  px-4 py-4 rounded-lg w-[60%] flex gap-4 flex-col sx:max-sm:w-[100%]  `} id='Authen'>
